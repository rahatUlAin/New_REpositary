...
// if($_SESSION['email']=='rain.bese16seecs@seecs.edu.pk'){echo 'yes';}
$sql1 = "SELECT * FROM reservation join user on reservation.creator_email=user.email where user.email='rain.bese16seecs@seecs.edu.pk'";
